...
function sectionCopy(section:Section){return{models:"Routing and connectivity",control_bot:"Operator approvals",telethon:"Telegram data plane",signing_key:"Evidence signatures",panel:"Authenticated access",privacy:"Retention on this machine"}[section];}
