...
export function DemoView() {
  ...
  const activeSummary = useMemo(() => runs.data?.find(run => !["completed","cancelled","stopped","failed"].includes(String(run.status).toLowerCase())), [runs.data]);
  ...
  const run = current.data || activeSummary;
