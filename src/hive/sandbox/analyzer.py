...
def analyze_url(url: str, runner: BrowserRunner) -> dict[str, Any]:
    ...
    return {
        ...
        "certificate_age_days": findings.certificate_age_days,
        "certificate_error": findings.certificate_error,
        "runtime_ms": findings.runtime_ms,
        ...
        "sandbox_image": findings.sandbox_image,
        "sandbox_image_id": findings.sandbox_image_id,
        "sandbox_contract": findings.sandbox_contract,
        "sandbox_python_version": findings.sandbox_python_version,
        "sandbox_scrapling_version": findings.sandbox_scrapling_version,
